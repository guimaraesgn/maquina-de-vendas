...
class TkRGBLED(TkDevice):
    ...
    def update(self):
        ...
        if self._previous_state != self._current_state:
            ...
            #rgba_components = [value for value in self._current_state]
            #rgba_components = [self._current_state[0]** 0.3 * 0.6 + 0.4, 0, 0]
            rgba_components.append(alpha)
            print(rgba_components)
